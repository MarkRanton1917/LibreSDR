...
proc ps7_clock_init_data_3_0 {} {
    ...
    mask_write 0XF800012C 0x01FFCCCD 0x01DCC4CD
    mwr -force 0XF8000004 0x0000767B
}
proc ps7_ddr_init_data_3_0 {} {
    ...
    mask_write 0XF800612C 0x000FFFFF 0x0002580E
    mask_write 0XF8006130 0x000FFFFF 0x0002680C
    mask_write 0XF8006134 0x000FFFFF 0x00026821
    mask_write 0XF8006138 0x000FFFFF 0x00026821
    ...
    mask_write 0XF8006154 0x000FFFFF 0x0000008E
    ...
    mask_write 0XF800616C 0x001FFFFF 0x000000EF
    mask_write 0XF8006170 0x001FFFFF 0x000000EF
    mask_write 0XF8006174 0x001FFFFF 0x000000EF
    mask_write 0XF800617C 0x000FFFFF 0x000000CE
...
proc ps7_peripherals_init_data_3_0 {} {
    ...
    mask_write 0XE000A244 0x003FFFFF 0x00088000
    mask_write 0XE000A008 0xFFFFFFFF 0x7FFF8000
    mask_write 0XE000A248 0x003FFFFF 0x00088000
